...
$retorno_mensagens = mysqli_query($conecta, $sql_mensagens);
...
$qtd = 3;
$total = 0;
$sql_mensagem = "SELECT COUNT(*) AS c FROM mensagem";
$sql_mensagem = mysqli_query($conecta, $sql_mensagem);
$sql_mensagem = mysqli_fetch_assoc($sql_mensagem);
$total =  $sql_mensagem['c'];
$paginas = $total / $qtd;
...
$sql_mensagens = "SELECT * FROM mensagem ORDER BY id LIMIT $p, $qtd";
$retorno_mensagens = mysqli_query($conecta, $sql_mensagens);
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="paginas.php">Mensagens</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Mensagens <small>Gerenciamento de Suas Páginas</small></h1>
              ...
              <div class="panel panel-default ">
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-hover">
                      <?php if(mysqli_fetch_row($retorno_mensagens) == 0){

                        echo "<h1 style='text-align: center;'>Nao ha mensagens!</h1>";

                      }; ?>
                        <?php foreach($retorno_mensagens as $mensagem):  ?>
                        <tr class="alert alert-danger" style="margin-top: 5px;">
                          <th>Nome</th>
                          <th>Email</th>
                          <th>Telefone</th>
                          <th>Data</th>
                          ...
                          <tr>
                            <th>Assunto</th>
                            <td colspan="3"><?=$mensagem['mensagem']?></td>
                          </tr>
                          <tr>
                            <td colspan="2"></td>
                            <td><a class="btn btn-primary" href="mailto:<?=$mensagem['email']?>?Subject=Contato%20<?=$retorno_config['nomeDaEmpresa']?>">Responder</a></td>
                            <td><a class="btn btn-danger" href="model/excluiMensagem.php?id=<?=$mensagem['id']?>">  Excluir    </a></td>
                          </tr>
                      ...
                      <ul class="pager">
                            <li >
                               <?php
                                for($q = 0; $q < $paginas; $q++){
                                    echo '<a href="mensagens.php?p='.($q+1).'"> '.($q+1).'</a>';
                                }
                               ?>
                            </li>
                      </ul>
