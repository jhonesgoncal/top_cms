      ...
      <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <form id="login" action="model/efetuaConfig.php" class="well" method="post">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Digite o  nome da empresa/organizacao/pessoa" name="nome-empresa" required>
                    </div>
                    <div class="form-group">
                      <label>Url</label>
                      <input type="text" class="form-control" placeholder="Digite a url" name="url" required>
                    </div>
                    <div class="form-group">
                      <label>Facebook</label>
                      <input type="text" class="form-control" placeholder="Digite o facebook" name="facebook" required>
                    </div>
                    <div class="form-group">
                      <label>Twitter</label>
                      <input type="text" class="form-control" placeholder="Digite o twitter" name="twitter" required>
                    </div>
                    <div class="form-group">
                      <label>LinkedIn</label>
                      <input type="text" class="form-control" placeholder="Digite o LinkedIn" name="LinkedIn" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Sobre</label>
                      <textarea  class="form-control" rows="20" placeholder="Escreva um pouco sobre como surgiu o site, historia da empresa/organizacao/pessoal que idealizou o site e conquistas da mesma. " name="sobre" id="editor" required></textarea>
                    </div>
                  </div>
                </div>
                  <button type="submit" class="btn btn-default btn-block">Configurar</button>
                  <?php
