  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Dashboard <small>Gerenciamento do Seu Site</small></h1>
                ...
                <div class="panel-body">
                  <div class="col-md-3">
                    <div class="well dash-box">
                      <h2><span class="glyphicon glyphicon-user" aria-hidden="true"> <?=$retorno['numeros']?></h2>
                      <h4>Administradores</h4>
                    </div>
                  </div>
                  <div class="col-md-3 ">
                    <div class="well dash-box">
                      <h2><span class="glyphicon glyphicon-list-alt" aria-hidden="true"> <?=$resultado_mensagens['numeros']?></h2>
                      <h4>Mensagens</h4>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="well dash-box">
                      <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"> <?=$resultado_noticias['numeros']?></h2>
                      <h4>Noticias</h4>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="well dash-box">
                      <h2><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> <?= pegaVisitas(); ?></h2>
                      <h4>Visualizacoes</h4>
                    </div>
                  </div>
                </div>
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <?php foreach ($resultado as $usuario): ?>
                        <tr>
                          <td><?=$usuario['nome']?></td>
                          <td><?=$usuario['email']?></td>
                          <td><a href="model/excluirAdmin.php?id=<?=$usuario['id']?>" class="btn btn-danger btn-small">Exluir</a></td>
                        </tr>
                      <?php endforeach; ?>
                    </table>
                    <?php
